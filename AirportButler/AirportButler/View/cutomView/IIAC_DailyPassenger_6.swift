...
struct IIAC_DailyPassenger_6: View {
                                ...
                                ForEach(viewModel.groupedItems[key] ?? []) { item in
                                    VStack(alignment: .leading, spacing: 10) {
                                        ...
                                        HStack {
                                            Text("합계")
                                            Spacer()
                                            Text("\(convertToInt(item.t2sumset2))")
                                                .fontWeight(.bold)
                                            + Text("명")
                                        }
                                    }
...
struct IIAC_DailyPassenger_6_Previews: PreviewProvider {
